...
# test in 307 (Tier B — genuine-HF cross-check + loader cover).
#
# This ungated tiny checkpoint ships an ACTIVE rope_type=llama3 long-context
# schedule — exactly the delta 307 implements — so nothing is forced (unlike 309).
...
#
#   307_llama31_model/llama31_tiny.npz               weights (git-ignored)
#   307_llama31_model/tests/fixtures/real_ref.npz    committed reference
set -euo pipefail
