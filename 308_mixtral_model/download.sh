...
# real-weights parity test in 308.
#
...
#
#   308_mixtral_model/mixtral_tiny.npz                  weights (git-ignored)
#   308_mixtral_model/tests/fixtures/real_ref.npz       committed reference
set -euo pipefail
