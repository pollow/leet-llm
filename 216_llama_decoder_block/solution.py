...
from leet_llm import AttnParams, SwiGLUParams, rms_norm, rope_interleaved, sdpa, swiglu_ffn, add_residual, group_last_axis, affine, triangular_mask, ungroup_last_axis
...
def llama_decoder_block(
    ...
    attn = _rope_gqa(a, params.attn, n_heads, n_kv_heads, positions, mask)
