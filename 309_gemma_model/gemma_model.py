"""309 — GeGLU + softcap + sandwich norm: Gemma-2 whole-model forward.
...
def softcap(x: np.ndarray, cap: float) -> np.ndarray:
    ...
    """
    raise NotImplementedError("Implement softcap — see 309_gemma_model/README.md")
...
def geglu_ffn(x: np.ndarray, params: GeGLUParams) -> np.ndarray:
    ...
    .. math::
        ...
        \\right)
    """
    raise NotImplementedError("Implement geglu_ffn — see 309_gemma_model/README.md")
...
def load_gemma(weights: dict, cfg: GemmaConfig) -> GemmaParams:
    ...
    """
    raise NotImplementedError("Implement load_gemma — see 309_gemma_model/README.md")
...
def gemma_forward(
    ...
    """
    raise NotImplementedError("Implement gemma_forward — see 309_gemma_model/README.md")
