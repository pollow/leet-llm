"""307 — Sparse MoE FFN (moe_ffn) + Mixtral whole-model forward.
...
def moe_ffn(
    ...
    np.ndarray
        Same shape as ``x``.
    """
    raise NotImplementedError("Implement moe_ffn — see 307_mixtral_model/README.md")
...
def load_mixtral(weights: dict, cfg: MixtralConfig) -> MixtralParams:
    ...
    """
    raise NotImplementedError("Implement load_mixtral — see 307_mixtral_model/README.md")
...
def mixtral_forward(
    ...
    """
    raise NotImplementedError("Implement mixtral_forward — see 307_mixtral_model/README.md")
