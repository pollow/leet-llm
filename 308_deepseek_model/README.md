...
Reuse: `moe_ffn` (307), `rope_half` (213), `rms_norm` (212), `softmax` (005),
...
- `307_mixtral_model/` — Mixtral MoE (DeepSeek MoE is the sigmoid+group-topk variant)
...
```bash
uv run grade 308                  # grade your implementation
uv run grade 308 -v               # verbose output
```
