"""310 — generate frozen golden fixtures for the GPT-OSS whole-model forward.

AUTHORING ONLY (needs the ``gen`` group):
    uv run --group gen python 310_gptoss_model/tests/gen_fixtures.py
...
scaling, deferred to 311 / L4 — see README).  Max observed diff is documented below.
