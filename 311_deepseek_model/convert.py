"""311 — fetch + convert real DeepSeek-V3 weights for the parity test.
...
this task (task 311 implements standard half-rotate RoPE only). The real-weights
...
Run with:
    LEET_LLM_TARGET=solution uv run --group gen python 311_deepseek_model/convert.py
"""
...
print("an extended implementation beyond task 311's scope.")
print("See 311_deepseek_model/README.md for details.")
sys.exit(0)
