...
REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "moe_ffn": ("308_mixtral_model", "moe_ffn"),
    "MixtralConfig": ("308_mixtral_model", "MixtralConfig"),
    "MixtralParams": ("308_mixtral_model", "MixtralParams"),
    "load_mixtral": ("308_mixtral_model", "load_mixtral"),
    "mixtral_forward": ("308_mixtral_model", "mixtral_forward"),
    "mla_project": ("311_deepseek_model", "mla_project"),
    "DeepseekConfig": ("311_deepseek_model", "DeepseekConfig"),
    "DeepseekParams": ("311_deepseek_model", "DeepseekParams"),
    "load_deepseek": ("311_deepseek_model", "load_deepseek"),
    "deepseek_forward": ("311_deepseek_model", "deepseek_forward"),
    "softcap": ("310_gemma_model", "softcap"),
    "geglu_ffn": ("310_gemma_model", "geglu_ffn"),
    "GeGLUParams": ("310_gemma_model", "GeGLUParams"),
    "GemmaConfig": ("310_gemma_model", "GemmaConfig"),
    "GemmaParams": ("310_gemma_model", "GemmaParams"),
    "load_gemma": ("310_gemma_model", "load_gemma"),
    "gemma_forward": ("310_gemma_model", "gemma_forward"),
    "attention_with_sinks": ("309_gptoss_model", "attention_with_sinks"),
    "gptoss_moe_ffn": ("309_gptoss_model", "gptoss_moe_ffn"),
    "GptOssConfig": ("309_gptoss_model", "GptOssConfig"),
    ...
    "rope_attention_scale": ("213_rope", "rope_attention_scale"),
