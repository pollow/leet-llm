# 311 — Long-Context RoPE Scaling: Llama-3.1 Whole-Model Forward
...
checkpoint ships an **active** `rope_type=llama3` schedule — exactly the delta 311
implements — so nothing is forced (contrast 310, which forced default RoPE). The
...
bash 311_llama31_model/download.sh
```
