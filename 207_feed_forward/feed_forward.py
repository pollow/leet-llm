...
Hint: reuse ``from leet_llm import affine, gelu, silu, relu`` (003, 202).
"""
...
def ffn(x: np.ndarray, params: FFNParams, activation: str = "gelu") -> np.ndarray:
    """Classic FFN with configurable activation: ``act(x @ W1.T + b1) @ W2.T + b2``.
    activation in {"gelu","relu","silu","swish"}, default "gelu" for backward compatibility.
    """
